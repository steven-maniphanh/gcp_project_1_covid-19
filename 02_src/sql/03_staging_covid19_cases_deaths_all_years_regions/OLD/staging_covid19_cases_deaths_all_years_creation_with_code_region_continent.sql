CREATE OR REPLACE TABLE `covid19-1-463112.staging_dataset_2_covid19_our_world.covid19_cases_deaths_all_years`
PARTITION BY date
...
SELECT country, c.country_code, c.region, c.continent, date, new_cases, total_cases, new_deaths, total_deaths
FROM full_data AS f
INNER JOIN `covid19-1-463112.staging_tranverse_dataset.country_dim` as c
ON f.country = c.country_name
