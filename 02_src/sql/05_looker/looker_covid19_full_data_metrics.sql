CREATE OR REPLACE TABLE `covid19-1-463112.looker_dataset_2_covid19_our_world.covid19_full_data_metrics`
PARTITION BY date
CLUSTER BY country
AS
...
WITH CTE AS (
  ...
  FROM `covid19-1-463112.curated_dataset_2_covid19_our_world.covid19_cases_deaths_full_data` AS c1
